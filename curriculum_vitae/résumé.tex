...
\begin{flushright}
% \parbox[c]{\textwidth}{Website: \url{https://nkostin.xyz} \\ Email: \href{mailto:contact@nkostin.xyz}{contact@nkostin.xyz} \\ GitHub: \url{https://github.com/nkostin4} \\ Mobile: +1 719-271-9108}
\parbox[c]{\textwidth}{Website: \url{https://nkostin.xyz} \\ Email: \texttt{nkostin@mines.edu} \\ GitHub: \url{https://github.com/nkostin4} \\ Mobile: +1 719-271-9108}
\end{flushright}
\end{minipage}
